...
#SBATCH -o /mimer/NOBACKUP/groups/oovgen/ziyuan/wasp-project/wasp-nlp/project/log/tabstar.out
#SBATCH -t 0-01:30:00
...
python /mimer/NOBACKUP/groups/oovgen/ziyuan/wasp-project/wasp-nlp/project/tests/tabstar_tests.py